...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ініціалізуємо форматування телефону
...
async function loadSettingsData() {
    try {
        ...
        // Форматуємо телефон перед збереженням
        ...
        if (data.Customer) {
            ...
            // Встановлюємо та форматуємо телефон
            const phoneInput = document.getElementById('phone');
        ...
        try {
            ...
            if (response.ok) {
                if (result.requiresReauth) {
                    ...
                    originalData = {
                        ...formData,
                        phone: phoneInput.value // Зберігаємо форматований телефон
                    };
